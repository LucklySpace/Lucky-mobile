...
class ShareApplicationDialog extends StatelessWidget {
  ...
  const ShareApplicationDialog({Key? key, this.url = 'https://www.baidu.com'})
      : super(key: key);
    ...
    return BaseDialog(
      ...
      children: <Widget>[
        ...
        const Text(
          '扫描二维码下载',
          style:
              TextStyle(fontSize: AppSizes.font14, color: AppColors.textHint),
        ),
        const SizedBox(height: AppSizes.spacing10),
        // Use Icon instead of Image if asset is missing
        const Icon(Icons.qr_code,
            size: AppSizes.spacing120, color: AppColors.textPrimary),
        ...
        Row(
          ...
          children: [
            ///浏览器打开
            _buildShareIcon(
                AppColors.wechat, Icons.public, () => _launchUrl(url)),
        ...
        const Row(
          ...
          children: [
            ...
            Text(
              '浏览器打开',
              style: TextStyle(
                  fontSize: AppSizes.font13, color: AppColors.textHint),
            ),
